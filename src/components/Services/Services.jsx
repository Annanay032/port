      ...
      <div className="cards">
        ...
        >
          <Card
            emoji={HeartEmoji}
            heading={"Design"}
            detail={"Figma, Sketch, Photoshop, Adobe Illustrator, Zeplin"}
          />
        </motion.div>
        {/* second card */}
        <motion.div
        ...
        >
          <Card
            emoji={Glasses}
            heading={"Developer"}
            detail={"Html, Css, JavaScript, React, Redux, SQL"}
          />
        </motion.div>
        {/* 3rd */}
        <motion.div
        ...
        >
          <Card
            ...
            heading={"Libraries"}
            detail={
              "Material ui, Ant Design, framer motion,  AgGrid, Tanstack, bootStap, Immer"
            }
